...
var TodoInputView = Backbone.View.extend({
  ...
  addTodo: function () {
    ...
    this.collection.add();  // CHALLENGE: add the appropriate data to the collection 
...
var TodoListView = Backbone.View.extend({
  ...
  render: function () {
    ...
    this.collection.models.forEach(function (item) {
      // CHALLENGE: combine the values for both model properties into their own html list items
